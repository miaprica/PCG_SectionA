...
public class MeshBuilder
{
    ...
    private List<int> triangleIndices = new List<int>(); // an index to the list of points to specify which points make up a triangle

    private List<Vector3> normals = new List<Vector3>(); // defines the direction of each vertex

    private List<Vector2> uv = new List<Vector2>();

    private List<int>[] submeshIndices = new List<int>[] { }; // array of submesh indices - the index points to an index of a material
